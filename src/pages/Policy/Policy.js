...
function Policy() {
  return (
    <>
      <Banner image={BannerImg} name="Policy" title="Policy"/>
      <div className="policy-page container">
        <article id="" className="page sans">
          <header>
            <h1 className="page-title text-center">DISCLAIMER</h1>
          </header>
          <div className="page-body">
            <p id="" className="">
              <strong>Last updated August 23, 2022</strong>
            </p>
            <h2 id="" className="">
              WEBSITE DISCLAIMER
            </h2>
            <p id="" className="">
              The information provided by HUIMITU (&quot;<strong>we</strong>
              ,&quot; &quot;<strong>us</strong>,&quot; or “<strong>our</strong>
              &quot;) on <a href="/">https://happygear.vercel.app/</a> (the
            ...
            <p id="" className="">
              ...
              We are not affiliated with users who provide testimonial, and
